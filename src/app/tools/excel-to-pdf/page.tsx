...
export default function ExcelToPdfPage() {
    ...
    const t = {
        ...
        title: { en: "Excel to PDF Converter", cn: "Excel 转 PDF 工具" },
        desc: { en: "Fast, precise, and secure conversion of Excel spreadsheets (.xlsx, .xls, .csv) to PDF format.", cn: "快速、精准、安全地将 Excel 表格 (.xlsx, .xls, .csv) 转换为 PDF 格式。" },
    ...
    return (
        <div className="min-h-screen p-4 sm:p-8 flex flex-col items-center max-w-4xl mx-auto">
            ...
            <div className="w-full flex flex-col gap-8">
                ...
                <FileUploadZone
                    acceptedFileTypes=".xlsx,.xls,.csv,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel,text/csv"
            ...
            <section className="w-full max-w-3xl mt-20 py-10 border-t border-zinc-800">
                <div className="prose prose-invert">
                    ...
                    <p className="text-zinc-400 mb-6">
                        {language === "en"
                            ? "This tool is powered by a secure, containerized LibreOffice engine (Gotenberg). When you upload an Excel spreadsheet, it is securely transmitted to our isolated cloud worker. The worker performs a high-fidelity conversion preserving all columns, rows, and charts, returns the PDF, and immediately destroys the original file from memory."
                            : "本工具底层的转换引擎基于安全的容器化 LibreOffice (Gotenberg)。您上传 Excel 表格后，会通过加密传输发送至我们独立的云节点。云节点将进行高保真转换（完美保留行列、图表排版），并将 PDF 返回给您，随后立即从内存中销毁原始文件。"}
                    </p>
